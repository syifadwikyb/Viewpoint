...
<header>
    ...
    <div class="input">
            <div class="gambar">
                <img src="asset/fujifilmXT100.png" alt="">
            </div>
            <div class="data">
                <?php 
            ...
            ?>
            <center>
            <p> Kamera yang anda pilih adalah FUJIFILM-X T100</p>
            <p> Biaya sewa per hari : 130 K</p>
            <p>Silahkan isi formulir pemesanan dibawah ini</p>
            </center>
            <br>
            <form action="go_fujifilm_T100.php" method="get"> 
                <div class="nama">
