...
<header>
    ...
    <div class="input">
            <div class="gambar">
                <img src="asset/canon 1300d.png" alt="">
            </div>
            <div class="data">
                <?php 
            ...
            ?>
            <center>
            <p> Kamera yang anda pilih adalah CANON EOS 1300D</p>
            <p> Biaya sewa per hari : Rp 100.000,-</p>
            <p>Silahkan isi formulir pemesanan dibawah ini</p>
            </center>
            <br>
            <form action="go_cannon1300d.php" method="get"> 
                <div class="nama">
